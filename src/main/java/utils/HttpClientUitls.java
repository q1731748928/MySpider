...
public class HttpClientUitls {
    ...
    public static String get(String url, Map<String, String> headers) {
        ...
        get.setHeader("cookie","cloudreve-session=MTY2ODA4NDU4NHxOd3dBTkZkQlNscFdXRWRLUVVSSVNEZEJVMHd6U1V0TlQxUklOVE5LVjBZeU1sTldURnBNVEV0RVFsaFpWMEZWTmpSUVZUTlRSa0U9fFDZQPaou3dxPgGvWjX8DyELcGntUnxGpF4BIkbTEUmU");
